...
A logger can be set for bunny by adding this config before calling `Hutch.connect`

```ruby
bunny_logger = Logger.new("/path/to/bunny.log")
Hutch::Config.set(:bunny_logger, bunny_logger)
```
